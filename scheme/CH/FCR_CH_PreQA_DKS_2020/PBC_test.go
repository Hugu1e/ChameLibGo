...
func run_scheme(t *testing.T, cur curve.Curve, group pbc.Field) {
	...
	h1, r1 := Hash(pp, pk, m1)
	t.Log("h1.H", h1.O.String())
	t.Log("r1.E_1", r1.E_1.String())
	t.Log("r1.E_2", r1.E_2.String())
	t.Log("r1.S_1_1", r1.S_1_1.String())
	t.Log("r1.S_1_2", r1.S_1_2.String())
	...
	t.Log("r1_p.S_1_1", r1_p.S_1_1.String())
	t.Log("r1_p.S_1_2", r1_p.S_1_2.String())
